...
CREATE TABLE historic_of_reproductions(
...
INSERT INTO users(user_name, age, plan_id, registration_date)
VALUES
...
INSERT INTO albuns(album_name, release_year, artist_id)
VALUES
  ('Renaissance', 2022, 1),
  ('Jazz', 1978, 2),
  ('Hot Space', 1982, 2),
...
INSERT INTO songs(song_name, song_duration, album_id)
VALUES
  ('BREAK MY SOUL', 279, 1),
...
INSERT INTO historic_of_reproductions(user_id, song_id, listen_date)
VALUES
